<?php /*a:2:{s:86:"/www/wwwroot/kyden.web.zhongwangyingtong.com/application/index/view/index/join_us.html";i:1637571227;s:79:"/www/wwwroot/kyden.web.zhongwangyingtong.com/application/index/view/layout.html";i:1672304802;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
	...
	<body>
		...
		<div class="ny-banner color-495877 join-banner" style="background-image: url(<?php echo htmlentities($cate['imagepath']); ?>)">
			<div class="core">
				<h3 class="font46 font-bold line-height-1em"><?php echo htmlentities($cate['picname']); ?></h3>
				<div class="banner-text"><?php echo htmlentities($cate['description']); ?></div>
			</div>
		</div>
		...
		<div class="join1 wow bounceInUp">
			<div class="core">
				<div class="index1-text2">
					<span><?php echo htmlentities($joinus['title']); ?></span>
				</div>

				<a class="join1-main" href="https://cn.linkedin.com/company/coyote-bioscience?trk=public_profile_experience-item_profile-section-card_image-click">
					<div class="join1-item" style="background-image: url(<?php echo htmlentities($joinus['image1_path']); ?>);width: 100%"></div>
				</a>
			</div>
		</div> 
		...
		<div class="join3 pageBg wow bounceInUp">
			<div class="core">
				<div class="index1-text2">
					<span><?php echo htmlentities($joinus['title2']); ?></span>
				</div>
