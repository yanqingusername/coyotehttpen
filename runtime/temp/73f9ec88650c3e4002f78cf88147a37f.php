<?php /*a:2:{s:91:"/www/wwwroot/kyden.web.zhongwangyingtong.com/application/index/view/index/news_details.html";i:1645867915;s:79:"/www/wwwroot/kyden.web.zhongwangyingtong.com/application/index/view/layout.html";i:1672304802;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
		...
		<div class="article">
			...
			<div class="core">
				...
				<div class="article-top">
					...
					<h3><?php echo htmlentities($news['title']); ?></h3>
				...
				<div class="article-main">
					...
					<div class="article-side">
						...
						<div class="article-time">
							...
							<p><?php echo htmlentities(date('Y.m.d',!is_numeric($news['inputtime'])? strtotime($news['inputtime']) : $news['inputtime'])); ?></p>
 ...
 -->
				...
				<a href="<?php echo url('news_type',['catid'=>$news['catid']]); ?>">
					...
					<div class="padding-t60">
						...
						<div class="article-back">
							...
							<span><?php echo htmlentities($news['catname']); ?></span>
