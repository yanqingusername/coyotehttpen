<?php /*a:2:{s:85:"/www/wwwroot/kyden.web.zhongwangyingtong.com/application/index/view/index/search.html";i:1642056140;s:79:"/www/wwwroot/kyden.web.zhongwangyingtong.com/application/index/view/layout.html";i:1672304802;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
	...
	<div class="core">
		...
		<form method="get" action="">
			<div class="search-from">
				<p>Search</p>
				<input type="text" id="search" value="<?php echo htmlentities($key_word); ?>" name="key_word" />
				<button class="search-btn" type="submit"></button>
			</div>
		</form>
		<div class="search-list">
			<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
			<a class="search-list-item" href="<?php echo url($item['type'],['id'=>$item['id']]); ?>">
				<div class="search-item-tip"><?php echo $item['type'] == 'news_details'?'News':'Systems'; ?></div>
				<div class="search-item-text">
					<h3><?php echo htmlentities($item['title']); ?></h3>
					<p><?php echo htmlentities($item['remark']); ?></p>
				</div>
			</a>
			<?php endforeach; endif; else: echo "" ;endif; ?>
		</div>
