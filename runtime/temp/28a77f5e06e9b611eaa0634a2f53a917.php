<?php /*a:2:{s:98:"/www/wwwroot/kyden.web.zhongwangyingtong.com/application/index/view/index/instrument_platform.html";i:1636005800;s:79:"/www/wwwroot/kyden.web.zhongwangyingtong.com/application/index/view/layout.html";i:1672304802;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
			...
			<div class="core">
				...
				<div class="instrument2 clearfix wow bounceInUp" style="background-image: url(<?php echo htmlentities($lab['recom_thumb_path']); ?>);">
					<div class="instrument2-text"> 
						...
						<a class="index-more" href="<?php echo url('index/instrument_lab'); ?>"><span>DETAILS</span><em></em></a>
					</div>
				</div>
			</div>
		</div>
