<?php /*a:2:{s:84:"/www/wwwroot/kyden.web.zhongwangyingtong.com/application/index/view/index/login.html";i:1642046140;s:79:"/www/wwwroot/kyden.web.zhongwangyingtong.com/application/index/view/layout.html";i:1672304802;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
	...
	<body>
		...
		<div class="login-main" style="background-image: url(/kayoudi/img/login/login-bg.jpg);">
			<div class="core">
				<div class="login-box">
					<h3>Login Account</h3>
					...
					<div class="login-item">
						...
						<div class="login-input">
							<i style="background-image: url(/kayoudi/img/login/login-icon1.png);"></i>
							<input type="text" id="" value="" />
						</div>
					</div>
					...
					<div class="login-item">
						<h4>Password</h4>
						<div class="login-input">
							<i style="background-image: url(/kayoudi/img/login/login-icon2.png);"></i>
