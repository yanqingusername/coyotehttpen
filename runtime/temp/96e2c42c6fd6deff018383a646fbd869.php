<?php /*a:2:{s:84:"/www/wwwroot/kyden.web.zhongwangyingtong.com/application/admin/view/index/index.html";i:1596677558;s:79:"/www/wwwroot/kyden.web.zhongwangyingtong.com/application/admin/view/layout.html";i:1628930008;}*/ ?>
<!DOCTYPE html>
<html>
...
<body class="layui-layout-body">
    <div class="layui-layout layui-layout-admin">
        <div class="layui-header">
            <a href="#" class="logo"><?php echo config('web_mp_name'); ?></a>
            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item">
                    <a href="javascript:;">
                        <i class="iconfont icon-richangqingli"></i>
                        <span class="winner-hide">&nbsp;清理缓存</span>
                    </a>
               ...
               <!--  <li class="layui-nav-item"><a href="javascript:;"><i class="iconfont icon-richangqingli"></i><span class="winner-hide">&nbsp;清理数据</span></a>
                    <dl class="layui-nav-child" id="deletedata">
                        <dd><a href="javascript:;" data-type="all">清理栏目模型<span class="layui-badge-dot"></span></a></dd>
                    </dl>
                </li> -->
                <?php endif; ?>
                <li class="layui-nav-item">
                    <a href="javascript:;" >
                        <!-- <img src="/static/admin/img/avatar.png" class="layui-nav-img userAvatar" width="35" height="35"> -->
                        <i class="iconfont icon-people"></i>
                        <span class="winner-hide">&nbsp;<?php echo htmlentities($userInfo['username']); ?></span>
                    </a> 
        ...
        <div class="layui-body" id="B_frame">
            <div class="layui-tab mag0" id="top_tabs_box" lay-filter="Tab">
                ...
                <ul class="layui-tab-title top_tab" id="B_history">
                    <li class="layui-this" lay-id="default"><i class="iconfont icon-homepage"></i>&nbsp;管理内容
                    </li>
                </ul>
                <div class="tab-right">
            ...
            <div class="layui-tab-content clildFrame">
                <div class="iframe_box">
                    <iframe id="iframe_default" src="<?php echo url('cms/cms/index',['menuid'=>57]); ?>" style="height: 100%; width: 100%;display:none;" lay-id="default" frameborder="0" scrolling="auto"></iframe>
                </div>
            </div>
        </div>
        <div class="layui-footer">
            © CMS v<?php echo htmlentities(app('config')->get('version.yzncms_version')); ?>
        </div>
    </div>
    ...
    layui.use(['element', 'layer', 'jquery'], function() {
        ...
        //清除数据
        $(document).on('click', "dl#deletedata dd a", function() {
            $.ajax({
                ...
                success: function(res) {
                    if (res.code == 1) {
                        var index = layer.msg('清除数据中，请稍候', { icon: 16, time: false, shade: 0.8 });
                        setTimeout(function() {
                            layer.close(index);
                            layer.msg("缓存数据成功！");
                        }, 1000);
