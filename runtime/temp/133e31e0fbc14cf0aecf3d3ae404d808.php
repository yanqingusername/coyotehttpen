<?php /*a:2:{s:85:"/Applications/phpstudy/coyotehttpen/application/index/view/index/solution-simple.html";i:1681354645;s:70:"/Applications/phpstudy/coyotehttpen/application/index/view/layout.html";i:1677057907;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
			...
			<div class="core">
				<div class="simple1">
					<div class="index-tit">
						...
						<p>
							<i></i>
							<span>Parallel reaction of molecules <span>VS</span> Regular reaction process</span>
							<i></i>
						</p>
					</div>
				...
				<div class="simple2">
					<div class="index-tit">
						...
						<p>
							<i></i>
							<span>Quick and easy operation</span>
							<i></i>
						</p>
					</div>
				...
				<div class="about-product">
					...
					<!-- <ul class="about-prolist">
						<?php if(is_array($solution['recommend']) || $solution['recommend'] instanceof \think\Collection || $solution['recommend'] instanceof \think\Paginator): $i = 0; $__LIST__ = $solution['recommend'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
							<li>
								<a href="<?php echo url('index/instrument_detail',['id'=>$item['id']]); ?>">
									<div class="about-proimg">
										<img src="<?php echo htmlentities($item['thumb_path']); ?>" alt="">
									</div>
									<div class="about-proname">
										<p><?php echo htmlentities($item['title']); ?></p>
									</div>
								</a>
							</li>
