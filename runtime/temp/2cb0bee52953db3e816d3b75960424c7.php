<?php /*a:2:{s:89:"/www/wwwroot/kyden.web.zhongwangyingtong.com/application/index/view/index/technology.html";i:1645497300;s:79:"/www/wwwroot/kyden.web.zhongwangyingtong.com/application/index/view/layout.html";i:1672304802;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
	...
	<body>
		...
		<div class="ny-banner technology-banner" style="background-image: url(<?php echo htmlentities($cate['imagepath']); ?>);">
			<div class="core">
				...
				<div class="ny-banner-text"><?php echo $cate['description']; ?></div>
			</div>
		</div>
		...
		<div class="technology-text wow bounceInUp">
			<div class="core"> 
				<div class="index1-text2">
					<span><?php echo htmlentities($technology['title']); ?></span>
				</div>
		...
		<div class="technology-text wow bounceInUp">
			<div class="core">
				<div class="index1-text2">
					<span><?php echo htmlentities($technology['title2']); ?></span>
				</div>
				<div class="technology-text-p">
