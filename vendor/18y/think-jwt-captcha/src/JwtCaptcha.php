...
namespace JwtCaptcha;

use think\captcha\Captcha as TpCaptcha;
 ...
 * 前后端分离图片验证码 
 */
class JwtCaptcha extends TpCaptcha
{
	private $uniqid;
	...
	public function getEntry($id = '')
	{
        ...
        $secode = $this->writeCache($id);
        $result = [
            'true_code' => implode('', $secode['source_code']),
            'code' => 0,
            'uniqid' => $this->uniqid,
